...
import { GraduationCap, Upload, Download, CheckCircle, XCircle, Truck, ArrowLeft } from 'lucide-react';
...
export function Degree({ studentData, onBack }: DegreeProps) {
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Your degree certificate application has been submitted and is under review.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-blue-900 mb-2">Application ID: <strong>DG2025{Math.floor(Math.random() * 10000)}</strong></p>
            <p className="text-blue-800 text-sm">Expected processing time: 10-15 working days</p>
          </div>
          <button
    ...
    <div>
      ...
      <div className="relative bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="absolute inset-0 opacity-20">
          <ImageWithFallback 
            src="https://images.unsplash.com/photo-1623461487986-9400110de28e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmFkdWF0aW9uJTIwY2VyZW1vbnl8ZW58MXx8fHwxNzYzNTE5NTYzfDA&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Graduation"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 py-12">
          <h1 className="text-white mb-3">Degree Certificate Application</h1>
          <p className="text-indigo-100 text-lg">Apply for your official degree certificate</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-gray-900">Degree Certificate Application</h2>
              <p className="text-gray-600">Apply for official degree certificate</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ol className="space-y-2 text-blue-800 text-sm list-decimal list-inside">
            <li>Kindly clear all the dues before applying for degree certificate</li>
            ...
            <li>Degree certificate issuance may take longer than marksheet</li>
          </ol>
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">₹300 - Delivery within 10-15 days</p>
                  </div>
                </div>
              </button>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-gray-900 mb-1">Degree Certificate Correction</h3>
              <p className="text-gray-600 text-sm">Request for correction in existing degree certificate</p>
            </div>
            <button
          ...
          {showCorrectionForm && (
            <div className="border-t border-gray-200 pt-6 space-y-4">
              <div>
                <label className="block text-gray-700 mb-2">Upload Current Degree <span className="text-red-600">*</span></label>
