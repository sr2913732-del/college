...
import { FileText, Download, Truck, AlertCircle, Upload, CheckCircle2, XCircle } from 'lucide-react';

export function MarksheetModule() {
  ...
  const handleApply = () => {
    if (!hasClearedDues) {
      alert('Please clear all dues before applying for marksheet');
      return;
    }
    alert('Marksheet application submitted successfully!');
  };

  const handleDownload = () => {
    alert('Downloading soft copy of marksheet...');
  };
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-blue-900 mb-2">Marksheet Application</h2>
        <p className="text-gray-600">Apply for your academic marksheet</p>
      </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-gray-600">₹150 delivery charges</p>
              </button>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-blue-900 mb-2">Marksheet Correction</h3>
            <p className="text-gray-600">Request correction for any errors in your marksheet</p>
          </div>
          <button
        ...
        {showCorrectionForm && (
          <form onSubmit={handleCorrectionSubmit} className="space-y-6 border-t border-gray-200 pt-6">
            ...
            <div>
              <label className="block text-gray-700 mb-2">
                Upload Current Marksheet <span className="text-red-500">*</span>
              </label>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li>• Processing time for marksheet is 10-15 working days</li>
